...
public class MainActivity extends ActionBarActivity {
    ...
    private void initContrls() {
        ...
        final int[] icons = {R.drawable.ic_acougue, R.drawable.ic_pescado, R.drawable.ic_launcher, R.drawable.donut, R.drawable.eclair, R.drawable.froyo, R.drawable.gingerbread, R.drawable.honeycomb, R.drawable.icecream_sandwhich, R.drawable.jellybean, R.drawable.kitkat};
